...
<div id="imgSlide" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
    ...
    <p><span class="fa fa-arrow-down"></span> Arrastra aquí tu imagen, tamaño recomendado: 1600px * 600px y Peso
        recomendado 1 MB</p>

    <ul id="columnasSlide">

        <?php
        //creando un objeto de la clase y llamando la funcion que devuelve todos los li con su respectivo URL
...
<div id="slide" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
    ...
    <ul>
        ...
        $llamandoController = NEW GestorSlide();
        $llamandoController->mostrarSlideTerminadoController();
        ?>
    </ul>
    </ul>

    <ol id="indicadores">
    <!--Los indicadores se traen desde el javascript-->
    </ol>
