...
<div id="suscriptores" class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
    ...
    <div>
        ...
        <a class="btn btn-info pull-right botonImprimePDF" style="margin:20px;" href="reporteWord">Imprimir Suscriptores Word</a>
        <a class="btn btn-success pull-right botonImprimePDF" style="margin:20px;" href="reporteExcel">Imprimir Suscriptores Excel</a>
        <a class="btn btn-warning pull-right botonImprimePDF" style="margin:20px;" href="tcpdf/pdf/suscriptores.php" target="_blank">Imprimir Suscriptores Pdf</a>
    </div>
